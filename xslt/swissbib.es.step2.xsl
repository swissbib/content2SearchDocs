...
/> 
    ...
    <xsl:param name="recordStructure" select="''"/>
    ...
    <xsl:variable name="myID" select="record/myDocId"/>    
    ...
    <xsl:variable name="fieldValues">
        ...
        <xsl:call-template name="createRecordStructure"/>
        ...
        <xsl:call-template name="createUniqueFields">
            <xsl:with-param name="fieldname" select="'time_processed'" />
            <xsl:with-param name="fieldValues" select="fn:string(current-dateTime())"/>
            <xsl:with-param name="withComma" select="false()"/>
        </xsl:call-template>
        
    </xsl:variable>{ "index" : {"_index":"test","_type":"mo","_id":"<xsl:value-of select="$myID"/>"}}
{<xsl:value-of   select="$fieldValues"/>}</xsl:template>
    ...
    <xsl:template name="id_type">
        ...
        <!--
        <xsl:call-template name="createUniqueFields">
            <xsl:with-param name="fieldname" select="'_id'"/>
            <xsl:with-param name="fieldValues" select="$fragment/myDocId"/>
        </xsl:call-template>
        -->
        <xsl:call-template name="createUniqueFields">
            <xsl:with-param name="fieldname" select="'recordtype'"/>
            <xsl:with-param name="fieldValues" select="'marc'"/>
        </xsl:call-template>
    ...
    <xsl:template name="classifications">
        ...
        <xsl:for-each select="$fragment/datafield[@tag='072']/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'classif_072'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='080']/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'classif_udc'"/>
                <xsl:with-param name="fieldValues" select="concat(., following-sibling::subfield[@code='x'][1], following-sibling::subfield[@code='x'][2], following-sibling::subfield[@code='x'][3])"/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='082']/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'classif_ddc'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='084']/subfield[@code='a']">
            <xsl:if test="matches(following-sibling::subfield[@code='2'], 'rvk', 'i')">
                ...
                <xsl:call-template name="createUniqueFields">
                    <xsl:with-param name="fieldname" select="'classif_rvk'"/>
                    <xsl:with-param name="fieldValues" select="."/>
                </xsl:call-template>
            ...
            <xsl:if test="matches(following-sibling::subfield[@code='2'], 'zdbs', 'i')">
                ...
                <xsl:call-template name="createUniqueFields">
                    <xsl:with-param name="fieldname" select="'classif_zdbs'"/>
                    <xsl:with-param name="fieldValues" select="."/>
                </xsl:call-template>
    ...
    <xsl:template name="authors">
        ...
        <xsl:for-each select="$fragment/sortauthor">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'author_sort'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
    ...
    <xsl:template name="titles">
        ...
        <xsl:for-each select="$fragment/datafield[@tag='245']/subfield[@code='a'][empty(following-sibling::subfield[@code='b'])]">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'title_sub'"/>
                <xsl:with-param name="fieldValues" select="following-sibling::subfield[@code='b'][1]" />
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='245']/subfield[@code='a'][exists(following-sibling::subfield[@code='b'])]">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'title'"/>
                <xsl:with-param name="fieldValues" select="concat(., ' : ', following-sibling::subfield[@code='b'])"/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/sorttitle">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'title_sort'"/>
                <xsl:with-param name="fieldValues" select="." />
            </xsl:call-template>
    ...
    <xsl:template name="bibid">
        ...
        <xsl:for-each select="$fragment/datafield[@tag='015']/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'nbn_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='016']/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'nbacn_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        </xsl:for-each>
        <xsl:for-each select="$fragment/datafield[@tag='020']/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'isbn'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='020']/subfield[@code='z']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'cancisbn_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='022']/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'issn'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='022']/subfield[@code='y']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'incoissn_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='022']/subfield[@code='z']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'cancissn_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='024'][@ind1='2']/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'ismn_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='024'][@ind1='2']/subfield[@code='z']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'cancismn_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='024'][@ind1='7'][matches(descendant::subfield[@code='2'],'doi', 'i')]/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'doi_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
        ...
        <xsl:for-each select="$fragment/datafield[@tag='024'][@ind1='7'][matches(descendant::subfield[@code='2'],'URN', 'i')]/subfield[@code='a']">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'urn_isn_mv'"/>
                <xsl:with-param name="fieldValues" select="."/>
            </xsl:call-template>
    ...
    <xsl:template name="series_hierarchy">
        ...
        <xsl:if test="exists($fragment//datafield[@tag='490']/subfield[@code='9'])">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'container_id'"/>
                <xsl:with-param name="fieldValues" select="'series'"/>
            </xsl:call-template>
            
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'is_hierarchy_id'"/>
                <xsl:with-param name="fieldValues" select="$fragment/myDocId"/>
            </xsl:call-template>
            

            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'is_hierarchy_title'"/>
                <xsl:with-param name="fieldValues" select="$fragment/datafield[@tag='245']/subfield[@code='a']"/>
            </xsl:call-template>
        ...
        <!-- replace with $i when data ready (osc / 18.01.2013) -->
        <xsl:variable name="forDeduplication">
            <xsl:for-each select="$fragment/datafield[@tag='490']/subfield[@code='v']">
                <xsl:value-of select="concat(., '##xx##')" />
            </xsl:for-each>
        </xsl:variable>
        <xsl:variable name="uniqueSeqValues" select="swissbib:startDeduplication($forDeduplication)"/>
    ...
    <xsl:template name="add_fields">
        ...
        <xsl:variable name="uniqueSeqValues" select="swissbib:startDeduplication($forDeduplication)"/>
        <xsl:call-template name="createUniqueFields">
            <xsl:with-param name="fieldname" select="'add_fields'"/>
            <xsl:with-param name="fieldValues" select="$uniqueSeqValues"/>
        </xsl:call-template>
    </xsl:template>
   ...
   <!-- ===
    ...
    <xsl:template name="submusic">
        ...
        <xsl:for-each select="$fragment/datafield[@tag='690'][matches(@ind1, 'F|L|I')][matches(@ind2, 'J|A|M')]/subfield[@code='a']">
            <xsl:variable name="tempSubMusic">
            ...
            <xsl:call-template name="createUniqueFields">
                ...
                <xsl:with-param name="fieldValues" select="$tempSubMusic"/>
            </xsl:call-template>
    ...
    <xsl:template name="sublocal">
        ...
        <xsl:for-each select="$fragment/datafield[@tag='690']/subfield[@code='a']">
            ...
            <xsl:variable name="tFieldNameSubLocal">
                <xsl:value-of select="concat('sublocal_', $ind1, $ind2)" />
            </xsl:variable>

            <xsl:variable name="tFieldValueSubLocal">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="$tFieldNameSubLocal" />
                <xsl:with-param name="fieldValues" select="$tFieldValueSubLocal"/>
            </xsl:call-template>
    ...
    <xsl:template name="fulltext">
        ...
        <xsl:for-each select="$fragment/uri856">
            ...
            <xsl:call-template name="createUniqueFields">
                <xsl:with-param name="fieldname" select="'fulltext'" />
                <xsl:with-param name="fieldValues" select="$fulltextcontent"/>
            </xsl:call-template>
    ...
    <xsl:template name="proctime_fullrecord">
        ...
        <xsl:call-template name="createUniqueFields">
            <xsl:with-param name="fieldname" select="'fullrecord'" />
            <xsl:with-param name="fieldValues" select="$nativeXML/fsource/record"/>
        </xsl:call-template>
    ...
    <xsl:template name="createHoldings">
        ...
        <xsl:call-template name="createUniqueFields">
            <xsl:with-param name="fieldname" select="'holdings'" />
            <xsl:with-param name="fieldValues" select="$holdingsStructure"/>
        </xsl:call-template>
    ...
    <!-- complete holdings structure as part of the bib record-->
    <xsl:template name="createRecordStructure">
        
        <xsl:call-template name="createUniqueFields">
            <xsl:with-param name="fieldname" select="'fullrecord'" />
            <xsl:with-param name="fieldValues" select="$recordStructure"/>
        </xsl:call-template>
    ...
    <xsl:template name="createUniqueFields">
        ...
        <xsl:param name="withComma" select="true()"/>
        
        <!-- replace linebreaks-->
        
        
        <xsl:variable name="toReplaceDouble">"</xsl:variable>
        <xsl:variable name="relaceWithDouble">\\"</xsl:variable>
        
        
        <xsl:if test="(count($fieldValues) > 0) and $fieldValues[1][. ne '']">
            
            <xsl:for-each select="$fieldValues">"<xsl:value-of   select="$fieldname"/>":"<xsl:value-of select="replace(.,$toReplaceDouble,$relaceWithDouble)"/>"<xsl:if test="$withComma">,</xsl:if></xsl:for-each>            
